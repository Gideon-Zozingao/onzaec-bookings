...
$allActiveBookingsSql="SELECT *FROM bookings JOIN rooms ON bookings.roomId=rooms.roomId WHERE bookings.propertyId='$_SESSION[account_id]' AND bookings.reservationStatus='Pending Confirmation'";
...
<thead>
  <?php echo $allActiveBookingQUeryResults."  Bookings Pending Confirmation";?>
</thead>
<tr>
  <th>Room</th>
...
<?php
  ...
  echo $allActiveBookingQUeryResults." Bookings Pending Confirmation";
}
}else{
